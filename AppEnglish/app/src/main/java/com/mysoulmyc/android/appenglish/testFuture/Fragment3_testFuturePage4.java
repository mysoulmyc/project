package com.mysoulmyc.android.appenglish.testFuture;
 ...
 */
public class Fragment3_testFuturePage4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        mixList = databaseAccess.getTestFu4();
        databaseAccess.close();

        txtTitle.setText("Future Perfect Continuous");
    ...
    private void setActivity() {
        ...
        if (currentMIX.getMixANSWER().equals(answer.getText())) {
            score++;
            Log.d("score", "Your score FuPerCon : " + score);
