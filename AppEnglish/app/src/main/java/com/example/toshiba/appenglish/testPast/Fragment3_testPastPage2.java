 ...
 */
public class Fragment3_testPastPage2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        quesList = databaseAccess.getTestPast2();
        answerList = databaseAccess.getChoicePast2();
    ...
    private void setActivity() {
        ...
        if (currentA.getANSWER().equals(answer.getText())) {
            score++;
            Log.d("score", "Your score PastCon : " + score);
    ...
    private void setScoreTest() {
        ...
        databaseAccess.open();
        databaseAccess.addScore(6, score);
