 ...
 */
public class Fragment3_testPrePage4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        mixList = databaseAccess.getTestPre4();

        databaseAccess.close();

        txtTitle.setText("Present Perfect Continuous");
    ...
    private void setActivity(){
        ...
        if (currentMIX.getMixANSWER().equals(answer.getText())) {
            score++;
            Log.d("score", "Your score PrePerCon : " + score);
   ...
   private void setScoreTest(){
       ...
       databaseAccess.open();
       databaseAccess.addScore(4,score);
