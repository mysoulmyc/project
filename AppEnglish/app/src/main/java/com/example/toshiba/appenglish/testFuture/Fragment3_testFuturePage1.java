 ...
 */
public class Fragment3_testFuturePage1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        mixList = databaseAccess.getTestFu1();
        //quesList = databaseAccess.getTestFu1();
        //answerList = databaseAccess.getChoiceFu1();
        databaseAccess.close();

        txtTitle.setText("Future Simple");
    ...
    private void setActivity() {
        ...
        if (currentMIX.getMixANSWER().equals(answer.getText())) {
            score++;
            Log.d("score", "Your score FuSim : " + score);
