 ...
 */
public class Fragment3_testPastPage1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        quesList = databaseAccess.getTestPast1();
        answerList = databaseAccess.getChoicePast1();
    ...
    private void setActivity() {
        ...
        if (currentA.getANSWER().equals(answer.getText())) {
            score++;
            Log.d("score", "Your score PastSim : " + score);
    ...
    private void setScoreTest() {
        ...
        databaseAccess.open();
        databaseAccess.addScore(5, score);
