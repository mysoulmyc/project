 ...
 */
public class Fragment3_testPastPage3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        databaseAccess.open();
        quesList = databaseAccess.getTestPast3();
        answerList = databaseAccess.getChoicePast3();
    ...
    private void setActivity() {
        ...
        if (currentA.getANSWER().equals(answer.getText())) {
            score++;
            Log.d("score", "Your score PastPer : " + score);
